...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/comp/pizza.png";
...
var resizePizzas = function(size) {
  ...
  //Removed redundant and unncessary calculations.
  function changePizzaSizes(size) {
    ...
    //Create randomPizza variable in order to prevent document.querySelectorAll()
    //from being called each time in the loop
...
function updatePositions() {
  ...
  //declare scrollTop outside the for loop in order to prefvent forced synchronus layout.
  // document.body.scrollTop||document.documentElement.scrollTop;
  //Used scrollY since scrollTop was giving me a forced reload in chrome.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    elem.src = "images/comp/pizza.png";
